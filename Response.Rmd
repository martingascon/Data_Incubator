---
title: "Challenge 3 - Data Incubator"
...
* If there is any effect, is this the same for different cities?
...
a) which cities are the 5 most/least expensive ones in the U.S. 
```{r, echo=FALSE}
...
rownames(most)[1:5]
```
All in California. 4 of them in Silicon Valley. 

b) which cities are the 5 least expensive ones in the U.S. 
```{r, echo=FALSE}
...
```
Curiously, where the headquarters of Google, Apple and Yahoo are. 
...
```
In this case, we have Palo Alto which includes Facebook. 
...
It is surprising the anticorrelation from Detroit with the Stock Markets.
